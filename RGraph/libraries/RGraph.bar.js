    ...
    : (this.data[i] > 0 ?
            ...
            for (var i=0,len=coords.length; i<len; i+=1) {
                ...
                if (this.context.isPointInPath(mouseX, mouseY)) {
                   ...
                   tooltip: typeof tooltip === 'string' ? tooltip : null,
                     label: prop.xaxisLabels && typeof prop.xaxisLabels[dataset] === 'string' ? prop.xaxisLabels[dataset] : null,
                   dataset: dataset,
                     index: idx,
           sequentialIndex: i
                    };
        ...
        this.drawAboveLabels = function ()
        {
            var labels      = prop.labelsAbove,
                ...
                offsetx     = prop.labelsAboveOffsetx,
            ...
            // BC
            if (typeof prop.labelsAboveOffset === 'number') {
                offsety = prop.labelsAboveOffset;
            }
                            ...
                            for (var j=0,len2=data[i].length; j<len2; j+=1) {
                                ...
                                RGraph.text({
                                  ...
                                  object: this,
                                    ...
                                    y:                  prop.xaxisPosition === 'top' ? coords2[i][j][1] + coords2[i][j][3] + 5 : coords2[i][j][1] + (data[i][j] < 0 ? coords2[i][j][3] + offsety : -offsety),
                                    text:               specific ? (specific[sequentialIndex] || '') : RGraph.numberFormat({
                                                            object:    this,
