       ...
       // Store the data set(s)
        ...
        this.drawMark = function (data_set_index, x, y, xMax, yMax, color, tooltip, coords, data, data_index)
        {
            ...
            if (   y
                ...
                var y0   = this.getYCoord(y[0], prop.outofbounds),
                    y1   = this.getYCoord(y[1], prop.outofbounds),
                    y2   = this.getYCoord(y[2], prop.outofbounds),
                    y3   = this.getYCoord(y[3], prop.outofbounds),
                    y4   = this.getYCoord(y[4], prop.outofbounds),
                    col1 = y[5],
                    col2 = y[6],
                ...
                //
                var yCoord = this.getYCoord(y, prop.outofbounds);
            }
        ...
        this.highlight = function (shape)
        {
            ...
            // Inverted highlight style
                ...
                var tickmarksSize = prop.tickmarksSize;

                // Clip to the graph area
                this.path(
                    'sa b r % % % % cl',
                    prop.marginLeft - tickmarksSize, prop.marginTop - tickmarksSize,
                    this.canvas.width - prop.marginLeft - prop.marginRight + tickmarksSize + tickmarksSize,
                    this.canvas.height - prop.marginTop - prop.marginBottom + tickmarksSize + tickmarksSize
                );
        ...
        this.drawTrendline = function  ()
        {
            ...
            y1 = this.getYCoord(y1, prop.outofbounds);
            x2 = this.getXCoord(x2);
            y2 = this.getYCoord(y2, prop.outofbounds);
        ...
        this.tooltipsFormattedCustom = function (specific, index)
        {
            ...
            if (   !RGraph.isNull(prop.tooltipsFormattedKeyColors)
                && typeof prop.tooltipsFormattedKeyColors === 'object'
                && typeof prop.tooltipsFormattedKeyColors[specific.dataset] === 'string'
               ) {
                var color = prop.tooltipsFormattedKeyColors[specific.dataset];
            }
            ...
            var label = prop.tooltipsFormattedKeyLabels[specific.index]
                           ? prop.tooltipsFormattedKeyLabels[specific.index]
                           : '';
