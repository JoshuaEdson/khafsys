...
(function (win, doc, undefined)
{
    RGraph.SVG.Bipolar = function (conf)
    {
        ...
        this.tooltipsFormattedCustom = function (specific, index)
        {
            ...
            var color = (!RGraph.SVG.isNull(prop.tooltipsFormattedKeyColors) && typeof prop.tooltipsFormattedKeyColors === 'object' && prop.tooltipsFormattedKeyColors[index])
                            ? prop.tooltipsFormattedKeyColors[index]
                            : prop.colors[index];
            ...
            if (typeof this[side][specific.dataset2] === 'object') {
                ...
                var label = (!RGraph.isNull(prop.tooltipsFormattedKeyLabels) && typeof prop.tooltipsFormattedKeyLabels === 'object' && prop.tooltipsFormattedKeyLabels[specific.dataset2])
