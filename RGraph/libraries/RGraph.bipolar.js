...
//
    ...
    RGraph.Bipolar = function (conf)
    {
        ...
        this.draw = function ()
        {
            ...
            if (prop.leftVisible) this.drawLeftBars({shadow: false});
            if (prop.rightVisible) this.drawRightBars({shadow: false});
        ...
        this.drawLabels = function ()
        {
            ...
            if (prop.xaxisLabels) {
                ...
                if (prop.leftVisible || prop.rightVisible) {
        ...
        this.getShape = function (e)
        {
            ...
            for (var i=0; i<this.coords.length; i++) {
               ...
               sequentialIndex: i,
                       ...
                       dataset: group,
                      dataset2: group2,
                         label: prop.yaxisLabels && typeof prop.yaxisLabels[group2] === 'string' ? prop.yaxisLabels[group2] : null
                    };
                }
            }
        ...
        this.tooltipsFormattedCustom = function (specific, index)
        {
            ...
            if (typeof this[side][specific.dataset2] === 'object') {
                ...
                label = (!RGraph.isNull(prop.tooltipsFormattedKeyLabels) && typeof prop.tooltipsFormattedKeyLabels === 'object' && prop.tooltipsFormattedKeyLabels[index])
                             ? prop.tooltipsFormattedKeyLabels[index]
                             : '';

            } else {
                label = (!RGraph.isNull(prop.tooltipsFormattedKeyLabels) && typeof prop.tooltipsFormattedKeyLabels === 'object' && prop.tooltipsFormattedKeyLabels[specific.index])
