    ...
    RGraph.SVG.Rose = function (conf)
    {
        ...
        this.tooltipsFormattedCustom = function (specific, index, colors)
        {
            ...
            if (typeof this.data[specific.dataset] === 'number') {
                ...
                color = !RGraph.SVG.isNull(prop.tooltipsFormattedKeyColors) && prop.tooltipsFormattedKeyColors[specific.index]
                            ? prop.tooltipsFormattedKeyColors[specific.index]
                            : color;
            ...
            // STACKED REGULAR CHART
                ...
                //label = prop.tooltipsFormattedKeyLabels[specific.dataset] || '';
                color = !RGraph.SVG.isNull(prop.tooltipsFormattedKeyColors) && prop.tooltipsFormattedKeyColors[index]
